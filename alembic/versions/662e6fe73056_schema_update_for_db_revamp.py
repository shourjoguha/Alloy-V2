...
def upgrade() -> None:
    ...
    # Create enum types explicitly (required because create_type=False is used)
    # Using DO blocks since CREATE TYPE doesn't support IF NOT EXISTS directly
    enum_definitions = [
        ...
        ('metrictype', ['reps', 'time', 'time_under_tension', 'distance']),
        ('ruleoperator', ['eq', 'gt', 'lt', 'lte', 'gte']),
        ('experiencelevel', ['beginner', 'intermediate', 'advanced', 'expert']),
        ('sessionsection', ['warmup', 'main', 'accessory', 'finisher', 'cooldown', 'cardio', 'conditioning']),
        ('disciplinetype', ['powerlifting', 'olympic_weightlifting', 'bodybuilding', 'crossfit', 'strongman', 'calisthenics', 'yoga', 'running', 'other']),
    ]
